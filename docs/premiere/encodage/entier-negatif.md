...
### La (partiellement) fausse bonne idée
...
Ce système d'écriture n'est pas idéal...
...
### Tableau des entiers en binaire **signé**
...
!!! conclu "Écriture de l'opposé d'un nombre positif"
    Considérons un nombre positif qui s'écrit sur **7 bits**, donc qu'il est de la forme ```0XXXXXXX```.
...
!!! conclu "Passage du binaire signé au nombre relatif"
